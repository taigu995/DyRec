...
echo Checking files:
if exist "next-build" (echo [OK] next-build exists) else (echo [MISSING] next-build)
if exist "next-build\BUILD_ID" (echo [OK] BUILD_ID exists) else (echo [MISSING] BUILD_ID)
